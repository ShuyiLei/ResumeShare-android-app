...
import edu.brandeis.cs.shuyilei.resumeshare.adapters.SearchResultAdapter;
import edu.brandeis.cs.shuyilei.resumeshare.adapters.SkillAdapter;
import edu.brandeis.cs.shuyilei.resumeshare.beans.Contact;
...
import edu.brandeis.cs.shuyilei.resumeshare.models.InstantLocationModel;
import edu.brandeis.cs.shuyilei.resumeshare.models.RequestModel;
...
import edu.brandeis.cs.shuyilei.resumeshare.utils.NetworkChecker;
import edu.brandeis.cs.shuyilei.resumeshare.views.activities.HomeActivity;

/**
 * Created by shuyilei on 11/13/16.
 */
